...
This project is designed so your LLM provider's API key stays on the server and is never sent to the
...
- If a key is ever exposed, **revoke it immediately** with your provider (for Anthropic, at
